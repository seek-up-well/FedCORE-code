...
if __name__ == "__main__":
    ...
    train_together(model_a, optimizer_a, scheduler_a, model_b, optimizer_b, scheduler_b, atrain_data, atest_data_uni, atest_data_com,
                   atest_data_non, btrain_data, btest_data_uni, btest_data_com, btest_data_non, id_vector, maxn, maxm, id_set, id_change)
