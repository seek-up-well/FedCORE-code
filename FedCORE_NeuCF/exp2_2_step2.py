...
SaveUV_dir = f"exp2_2/{dataset}-{timestamp}-copy{copy}-lr{LR}"
...
if __name__ == "__main__":
    ...
    SaveUV_dir = f'exp2_2/{dataset}-copy1-lr{lr}'
    ...
    if attacktpye == "1":
        avg_sim_arrack_origin, avg_sim_correspond_origin, avg_sim_arrack_correspond, MAE, RMSE, std1, std2, std3, avg_sim_arrack_origin_ncf, avg_sim_correspond_origin_ncf, avg_sim_arrack_correspond_ncf, MAE_ncf, RMSE_ncf, std1_ncf, std2_ncf, std3_ncf = attack_direct(
            uid_rating_dict, model_a, model_b, atrain_data_dict, maxn, maxm)
    elif attacktpye == "2":
        avg_sim_arrack_origin, avg_sim_correspond_origin, avg_sim_arrack_correspond, MAE, RMSE, std1, std2, std3, avg_sim_arrack_origin_ncf, avg_sim_correspond_origin_ncf, avg_sim_arrack_correspond_ncf, MAE_ncf, RMSE_ncf, std1_ncf, std2_ncf, std3_ncf = attack_average(
            uid_rating_dict, model_a, model_b, atrain_data_dict, maxn, maxm)
    elif attacktpye == "3":
        scale_noise = scale_temp
        avg_sim_arrack_origin, avg_sim_correspond_origin, avg_sim_arrack_correspond, MAE, RMSE, std1, std2, std3, avg_sim_arrack_origin_ncf, avg_sim_correspond_origin_ncf, avg_sim_arrack_correspond_ncf, MAE_ncf, RMSE_ncf, std1_ncf, std2_ncf, std3_ncf = attack_noise(
            uid_rating_dict, model_a, model_b, atrain_data_dict, scale_noise, maxn, maxm, clip_num)
    elif attacktpye == "4":
        scale_noise = scale_temp
        avg_sim_arrack_origin, avg_sim_correspond_origin, avg_sim_arrack_correspond, MAE, RMSE, std1, std2, std3, avg_sim_arrack_origin_ncf, avg_sim_correspond_origin_ncf, avg_sim_arrack_correspond_ncf, MAE_ncf, RMSE_ncf, std1_ncf, std2_ncf, std3_ncf = attack_average_noise(
            uid_rating_dict, model_a, model_b, atrain_data_dict, scale_noise, maxn, maxm, clip_num)

    file_result = open(
        f'exp2_2/{dataset}-copy1-lr{lr}-attacktpye{attacktpye}-itemtypegmf.txt', 'w+')
    file_result.write(
        f'{avg_sim_arrack_origin,avg_sim_correspond_origin,avg_sim_arrack_correspond,MAE,RMSE,std1,std2,std3}')
    file_result.close()

    file_result = open(
        f'exp2_2/{dataset}-copy1-lr{lr}-attacktpye{attacktpye}-itemtypencf.txt', 'w+')
    file_result.write(
        f'{avg_sim_arrack_origin_ncf,avg_sim_correspond_origin_ncf,avg_sim_arrack_correspond_ncf,MAE_ncf,RMSE_ncf,std1_ncf,std2_ncf,std3_ncf}')
    file_result.close()
